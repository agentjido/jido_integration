defmodule Jido.RuntimeControl.ExecutionEvent do
  ...
  @schema Zoi.struct(
            ...
            %{
              ...
              provider_request_id: Zoi.string() |> Zoi.nullish(),
              provider_item_id: Zoi.string() |> Zoi.nullish(),
              provider_tool_call_id: Zoi.string() |> Zoi.nullish(),
              provider_message_id: Zoi.string() |> Zoi.nullish(),

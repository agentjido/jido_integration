...
defmodule Jido.Integration.V2.ProviderFeatureMatrix.MixProject do
  use Mix.Project
  ...
  def project do
    [
      app: :jido_integration_v2_provider_feature_matrix,
      version: "0.1.0",
      elixir: "~> 1.19",
      ...
      dialyzer: dialyzer(),
      docs: docs(),
      name: "Jido Integration V2 Provider Feature Matrix",
      description: "Executable provider feature placement matrix"
    ]
  end

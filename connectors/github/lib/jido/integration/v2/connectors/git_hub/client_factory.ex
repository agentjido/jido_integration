defmodule Jido.Integration.V2.Connectors.GitHub.ClientFactory do
  @moduledoc false
  ...
  @spec build(map()) :: {:ok, GitHubEx.Client.t()} | {:error, :missing_access_token}
